...
using Foyer.Sessions;
using Foyer.Web.Controllers.Results;
using Foyer.Web.Models;
using Foyer.Web.Models.Account;
...
{
    public class AccountController : FoyerControllerBase
    {
