...
{
    public abstract class FoyerTestBase : AbpIntegratedTestBase<FoyerTestModule>
    {
        ...
        protected void UsingDbContext(Action<FoyerDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<FoyerDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<FoyerDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<FoyerDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<FoyerDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<FoyerDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<FoyerDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<FoyerDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<FoyerDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<FoyerDbContext, Task<T>> func)
        {
            T result;
